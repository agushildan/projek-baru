...
function Beranda() {
  ...
  "
      >
        ...
        <img
          src={bannerBeranda}
          alt="Banner PT. Digi Tekno Indonesia"
          className="
            absolute
            inset-0
            w-full
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(250,170,170,0.30) 0%, rgba(63,58,58,0.38) 20%, rgba(93,84,84,0.30) 42%, rgba(126,117,117,0.32) 62%, rgba(222,228,247,0.72) 90%)",
          }}
        ></div>
