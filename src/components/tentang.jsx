...
function TentangKami() {
  ...
  return (
    <section id="tentang" className="relative w-full py-16 px-6 md:px-16 lg:px-24 bg-gradient-to-b from-blue-50/40 via-sky-50/30 to-white overflow-hidden">
    ...
    <div key={i} className="w-1.5 h-1.5 bg-[#4b8cc0] rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center space-y-6 z-10">
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-semibold text-slate-800 tracking-wider">
            {t("judul_tentang")}
          </h2>

          <div className="space-y-5 text-gray-600 text-sm md:text-base leading-relaxed text-justify md:text-left">
            <p>
                {t("paragraft1")}
            </p>
